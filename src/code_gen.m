...
file(Artifact, IfaceImports-ImplImports, Decls, Facts) -->
    ...
    (
        ...
        separator,
        comment_line("File: " ++ Artifact ^ a_output),
        comment_line("NOTE: This file is automatically generated"),
        comment_line("Source: " ++ Artifact ^ a_input),
        separator,
        DeclWithBlank("module " ++ Artifact ^ a_module_name),
        ...
        separator,
        decl("end_module " ++ Artifact ^ a_module_name),
        separator,
        told
    ;
